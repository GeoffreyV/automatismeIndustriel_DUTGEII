...
Les \textbf{pré-actionneurs} remplissent la fonction \textit{distribuer} de la chaîne d'énergie. Ce sont eux qui  adaptent l'énergie puis la distubuent aux différents actionneurs. Ils \textbf{sont commandés par l'automate en vue de faire fonctionner les actionneurs}.
